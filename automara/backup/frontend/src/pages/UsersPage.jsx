...
function UsersPage() {
  ...
  const handleUpdateUser = async (e) => {
    ...
    try {
      ...
      // Try the correct API endpoints based on what we know works
      // We know /api/users works for GET, so let's try similar patterns
      const possibleUpdates = [
        // Try PUT to the users endpoint with ID
        { method: 'PUT', url: `/api/users/${selectedUser.id}` },
        // Try POST to a user update endpoint
        { method: 'POST', url: `/api/users/${selectedUser.id}/update` },
        // Try POST to users with action parameter
        { method: 'POST', url: `/api/users/update`, data: { ...updateData, id: selectedUser.id } },
        // Try PUT to a more specific endpoint
        { method: 'PUT', url: `/api/admin/users/${selectedUser.id}` },
        // Try POST to admin users
        { method: 'POST', url: `/api/admin/users/${selectedUser.id}` },
        // Try the pattern from the error - v1 endpoint
        { method: 'PUT', url: `/api/v1/users/${selectedUser.id}` },
        { method: 'POST', url: `/api/v1/users/${selectedUser.id}` }
      ];
      ...
      for (const update of possibleUpdates) {
        try {
          ...
          console.log(`Trying ${update.method} ${update.url} with data:`, requestData);
          ...
          success = true;
          console.log(`Success with ${update.method} ${update.url}`);
          break;
        } catch (error) {
          lastError = error;
          console.log(`${update.method} ${update.url} failed:`, error.message);
      ...
      console.error('Update data sent:', {
        ...
        email: editUser.email,
        role: editUser.role,
        tenant_name: editUser.tenant_name,
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justifycenter">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="overflow-x-auto">
                    ...
                    <td className="p-6">
                      <div className="flex items-center gap-4">
                        <div className="relative">
                          <div className="w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl flex items-center justifycenter text-white font-bold text-lg shadow-lg shadow-purple-500/25">
                            {getInitials(user)}
                          </div>
            ...
            {filteredUsers.length === 0 && (
              <div className="text-center py-20">
                <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-2xl flex items-center justifycenter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-gradient-to-br from-slate-900/50 to-slate-900/30 backdrop-blur-sm rounded-xl border border-slate-800 p-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-xl flex items-center justifycenter border border-purple-500/20">
          ...
          <div className="bg-gradient-to-br from-slate-900/50 to-slate-900/30 backdrop-blur-sm rounded-xl border border-slate-800 p-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-br from-emerald-600/20 to-teal-600/20 rounded-xl flex items-center justifycenter border border-emerald-500/20">
          ...
          <div className="bg-gradient-to-br from-slate-900/50 to-slate-900/30 backdrop-blur-sm rounded-xl border border-slate-800 p-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-600/20 to-cyan-600/20 rounded-xl flex items-center justifycenter border border-blue-500/20">
      ...
      {showEditModal && selectedUser && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justifycenter z-50 p-4">
              ...
              <form onSubmit={handleUpdateUser} className="space-y-6">
                ...
                <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-800">
                  ...
                  <div className="flex flex-col items-center gap-4 mb-4">
                    <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl flex items-center justifycenter text-white font-bold text-xl shadow-lg shadow-purple-500/25">
                ...
                <div className="flex gap-3 pt-6">
                  ...
                  >
                    {saving ? (
                      <div className="flex items-center justifycenter gap-2">
